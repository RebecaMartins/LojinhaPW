...
inner join tblCategoria
 ...
 select nomeAlbum,valorAlbum,grupoAlbum from vw_Album;

 -- select nomeAlbum,valorAlbum,grupoAlbum from vw_Album where lancamentoAlbum = 'S'; --
-- codigo onde executa apenas os albuns que sao lancamento no site!! --
