...
<head>
<meta charset="utf-8">
<title>Lojinha - Form usuario</title>
...
<script>
	// a funcao mask do jquery sendo aplicada (a sensura do numero ou senha)
$(document).ready(function(){
    $("#cep").mask("00 000-000");
    //$("#celular").mask ("(00)00000-0000"); exemplo pra celular
});
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-sm-4 col-sm-offset-4">
				...
				<form method="post" action="inseriru suario.php" name="logon">
