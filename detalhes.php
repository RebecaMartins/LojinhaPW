// arquivo da aula 38, mas a pagina sera apenas criada, mas nao logada ao site ja que nao é
// possivel adicionar imagens nesse projeto no momento
...
<body>	
    ...
    if (!empty($_GET['album'])){
        $cd_album = $_GET ['album'];
        $consulta = $cn ->query("select * from valor_Album where codAlbum='$codAlbum'");
